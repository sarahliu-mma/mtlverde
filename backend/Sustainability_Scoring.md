...
the full reasoning behind the model, see [`Sustainability_Logic.md`](./Sustainability_Logic.md).
...
See [`Sustainability_Logic.md`](./Sustainability_Logic.md) for the full methodology, the decision history, and the
